            ...
            <section className={"row p-4 publisherContainer m-1" + `section ${showPublisher ? "hidden" : ""}`}>
                ...
                <div className="col-md-5">
                    ...
                    {allBookCategories.map(bookCategory => (
                        <option key={bookCategory.kategoriaNro}>{bookCategory.kategoria}</option>
                    ))}
                    </select>
                    ...
                    {allBookCategories.map(bookCategory2 => (
                        <option key={bookCategory2.kategoriaNro}>{bookCategory2.kategoria}</option>
                    ))}
                    </select>
                    ...
                    {allBookCategories.map(bookCategory3 => (
                        <option key={bookCategory3.kategoriaNro}>{bookCategory3.kategoria}</option>
                    ))}
                    </select>
                    ...
                    {allBookCategories.map(bookCategory4 => (
                        <option key={bookCategory4.kategoriaNro}>{bookCategory4.kategoria}</option>
                    ))}
                    </select>
                </div>

                <div className="col-md-4">
                    <label htmlFor="tiedosto" className="form-label">Lisää kuva</label>
